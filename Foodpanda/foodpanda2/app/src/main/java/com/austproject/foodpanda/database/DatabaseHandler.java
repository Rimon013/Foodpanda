package com.austproject.foodpanda.database;
...
public class DatabaseHandler extends SQLiteOpenHelper{
	...
	public void addContact(Contact contact)
	{
		...
		String query = "INSERT INTO CONTACT(NAME,EMAIL,PASSWORD)" +
		...
		value.put(KEY_EMAIL,contact.getContactNumber());
	...
	public Contact getSingleContact(int id)
	{
		...
		//Cursor cursor = db.query(TABLE_NAME, new String[] {KEY_ID,KEY_NAME,KEY_EMAIL}, "Id=?",new String[]{String.valueOf(id)} ,null, null,null, null);
		Contact myContact = null;
		if(cursor.moveToFirst())
		{
			myContact=new Contact(Integer.parseInt(cursor.getString(0)),cursor.getString(1),cursor.getString(2),cursor.getString(3));
		}
	...
	public List<Contact> getAllContact()
	{
		...
		if(cursor.moveToFirst())
		{
			do
			{
				Contact contact= new Contact(Integer.parseInt(cursor.getString(0)),cursor.getString(1),cursor.getString(2), cursor.getString(
				3));
	...
	public void updateContact(Contact contact)
	{
		...
		String query = "UPDATE CONTACT SET phoneno='014' WHERE ID = "+contact.getId() ;
		db.execSQL(query);
